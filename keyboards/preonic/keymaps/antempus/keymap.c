 ...
 */
    [_WIN] = LAYOUT_preonic_grid(
        ...
        KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT,
        _______, KC_LGUI, KC_LALT, KC_LCTL, LOWER, KC_SPC, KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|AudOff|AGnorm|AGswap| MACOS| WIN |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+-----|
 ...
 */
    [_ADJUST] = LAYOUT_preonic_grid(
        ...
        _______, _______, MU_MOD, AU_ON, AU_OFF, AG_NORM, AG_SWAP, MACOS, WIN, _______, _______, _______,
